 ...
 * примера в консоль
 * 
 * Класс App используется для запуска процедур отправки сообщений на НРЛС MP-231 и МР-231-3
 * 
 * Для читабельности полученных данных с принятых сообщений в форматах TTM, RSD, VHW, 
 * используются конвертеры(парсеры), описанные в протоколах.
 * 
 */
...
public class App {
    public static void main(String[] args) {
        ...
        for (String mr231_3_Message : mr2313Messages) {
            searadarMessages3.addAll(converter3.convert(mr231_3_Message));
        }
